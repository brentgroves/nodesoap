...
soap.createClient(plexWSDL, function(err, client) {
  ...
  debugger;
  client.setSecurity(new soap.BasicAuthSecurity('BuscheAvillaKorsws@plex.com', '5b11b45-f59f-'));
  debugger;
  client.ExecuteDataSource(request_data, function(err, result) {
    ...
    debugger;  
    console.log(result.ExecuteDataSourceResult.ResultSets.ResultSet[0].Rows.Row[0].Columns.Column[0].Name);
    var res=result.ExecuteDataSourceResult.ResultSets.ResultSet[0].Rows.Row[0].Columns.Column
